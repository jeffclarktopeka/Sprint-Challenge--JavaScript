...
const universities = [`${university.sort()}`];
...
const unisWithUni = [`${university.includes('uni')}`];
...
displaysNames.forEach( displayNames =>
...
lowCaseAnimalNames.map(animal_names.toLowerCase)
...
lowPopulationAnimals.filter(population < 5)
